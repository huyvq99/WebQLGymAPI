...
namespace Foody.Controllers
{
    ...
    public class RestaurantsController : ControllerBase
    {
        ...
        public RestaurantsController(FoodyDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("area/{id}")]
        public async Task<ActionResult<List<Restaurant>>> GetRestaurants(Guid id)
        {
            var restaurants = await _context.Restaurants.Where(x => x.AreaId == id).ToListAsync();
            return restaurants;
        }
